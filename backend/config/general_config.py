...
from utils.proxy import getProxies
...
class ABConfig():
    ...
    def __init__(self, args=None):
        ...
        try:
            ...
            # network
            try:
                self.HTTP_PROXY_LIST =  config["NETWORK"]["proxy_list"].split(",") #getProxies() #
            ...
            try:
                ...
                logger.info("No user agent list in config/" + username +
            ...
            try:
                ...
                logger.warning("For more information, see config/example.config")
                self.URL_API_SEARCH_ROOT = self.URL_ROOT + "s/homes"
            try:
